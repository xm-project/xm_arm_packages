...
const double l_gripper = 0.26;
const double PI = 3.1415926;

//  joint_lifting ,joint_waist , joint_big_arm, joint_fore_arm, joint_wrist
// ik解算器，和scripts文件夹的python实现一样
const double joint_range_max[6] = {0.035, 1.57, 1.57, 2.10, 2.2, 1.57};
const double joint_range_min[6] = { -0.18, -0.35, -1.57, -2.10, -2.2, -1.57};

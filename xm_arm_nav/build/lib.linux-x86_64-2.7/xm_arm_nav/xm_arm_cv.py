...
class FindObject(State):
    def __init__(self):
        State.__init__(self,
                         ...
                         input_keys=['name'],
                         output_keys =['object_pos','objmode'])
...
class GraspSmach(State):
    ...
    def execute(self,userdata):
        ...
        userdata.arm_ps.point.z += zz
        userdata.arm_ps.point.x += xx
        userdata.arm_ps.point.y += yy
